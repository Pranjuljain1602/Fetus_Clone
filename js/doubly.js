if (typeof CurrenciesJSON === 'undefined') {
    ...
    if (typeof jQuery == 'undefined' || (typeof jQuery !== 'undefined' && typeof jQuery.get === 'undefined') || DoublyGlobal.forceJqueryLoad) {
    ...
    var bccWaitReadyInterval = setInterval(function(){
        if (typeof DoublyGlobal !== 'undefined') {
            ...
            clearInterval(bccWaitReadyInterval);
            console.error('BEST currency converter startup failed.');
        }
    }, 100);
}